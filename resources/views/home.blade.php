                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <h6 style="-moz-text-decoration-color: #0b2e13">عدد الفواتير</h6>
                                <p style="-moz-text-decoration-color: #0b2e13" class="mb-0 tx-12 text-white op-7">{{ \App\invoices::count() }}</p>
                            </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <h6 style="-moz-text-decoration-color: #0b2e13">عدد الفواتير الغير مدفوعة</h6>

                                <p class="mb-0 tx-12 text-white op-7">{{ \App\invoices::where('Status','غير مدفوعة')->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                   ...
                                   {{round(\App\invoices::where('Status','غير مدفوعة')->count()/\App\invoices::count() *100)}}%
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <h6 style="-moz-text-decoration-color: #0b2e13">عدد الفواتير المدفوعة</h6>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ \App\invoices::where('Status','مدفوعة')->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                                      {{round(\App\invoices::where('Status','مدفوعة')->count()/\App\invoices::count() *100)}}%
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <h6 class="mb-3 tx-12 text-white">عدد الفواتير المدفوعة جزئيا </h6>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ \App\invoices::where('Status','مدفوعة جزئيا')->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">
                                   {{round(\App\invoices::where('Status','مدفوعة جزئيا')->count()/\App\invoices::count() *100)}}%
                                </span>
                            </span>
                        </div>
                    </div>
